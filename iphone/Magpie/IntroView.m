...
- (void)drawRect:(CGRect)rect {
	switch (type) {
		...
		case 1:
			...
			[@"An entry is a time stamped value attached to an Item. They let you track values per Item over time." drawInRect:CGRectMake(15.0, 288.0, 210.0, 250.0) withFont:standardFont lineBreakMode:UILineBreakModeWordWrap];
		...
		case 2:
			...
			[@"Now that you have a general understanding of the basic concepts behind Magpie, you can follow the in-app tutorial bubbles to create your first Category and Display, and start adding Entries." drawInRect:CGRectMake(15.0, 143.0, 290.0, 400.0) withFont:standardFont lineBreakMode:UILineBreakModeWordWrap];
			[@"You can always come back to this introduction by tapping on the Magpie logo under the main screen." drawInRect:CGRectMake(15.0, 244.0, 290.0, 400.0) withFont:standardFont lineBreakMode:UILineBreakModeWordWrap];
