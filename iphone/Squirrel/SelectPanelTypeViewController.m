...
- (void)viewDidLoad {
	...
	if (panelTypes == nil) {
		panelTypes = [[NSArray alloc] initWithObjects:@"Pie Chart", @"Bar Chart", @"Latest Entry as Words", @"Latest Entry as Numbers", @"Latest Entry Type", @"Total as Words", @"Total as Numbers", nil];
	}
}
